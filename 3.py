...
'''
1. Определение четности числа: Определите, является ли заданное число четным или нечетным.
2. Минимум из двух чисел: есть три числа. Выведите наименьшее из них.
3. Определение знака числа: Выясните, является ли число положительным, отрицательным или равным нулю.
4. Определение дня недели: Определите, является ли сегодняшний день рабочим или выходным.
5. Определение координатной четверти: По заданным координатам точки на плоскости (x,y) определите, в какой четверти она находится.
6. Калькулятор (простейший): есть два числа и символ операции (+, -, *, /). В зависимости от символа, выполните арифметическое действие.
7. Существование треугольника: Заданы три числа (длины отрезков). Проверьте, могут ли они являться сторонами треугольника.
'''