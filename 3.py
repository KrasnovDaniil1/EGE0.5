...
'''
1. Узнать число четное или не четное
2. Узнайте число положительное, отрицательное или 0
3. Узнайте сегодня рабочий день или выходной 
3. Дана координатная точка на плоскости (x и y). Необходимо определить четверть, в которой находится эта точка.
4. Даны длины четырех сторон четырехугольника. Определите тип четырехугольника.
